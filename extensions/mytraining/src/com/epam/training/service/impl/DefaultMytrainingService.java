...
public class DefaultMytrainingService implements MytrainingService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMytrainingService.class);
	...
	{
		return DefaultMytrainingService.class.getResourceAsStream("/mytraining/sap-hybris-platform.png");
	}
