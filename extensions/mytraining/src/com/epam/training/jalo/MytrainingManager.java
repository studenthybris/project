...
public class MytrainingManager extends GeneratedMytrainingManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(MytrainingManager.class);
	...
	{
		return (MytrainingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MytrainingConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of MytrainingManager called, current tenant: {}", getTenant().getTenantID());
	}
