 ...
 */
package de.hybris.platform.mytraininghmc.jalo;
...
public class MytraininghmcManager extends GeneratedMytraininghmcManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(MytraininghmcManager.class);
	...
	{
		return (MytraininghmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MytraininghmcConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of MytraininghmcManager called, current tenant: {}", getTenant().getTenantID());
	}
