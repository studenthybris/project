...
public class DefaultMytraininghmcService implements MytraininghmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMytraininghmcService.class);
	...
	{
		return DefaultMytraininghmcService.class.getResourceAsStream("/mytraininghmc/sap-hybris-platform.png");
	}
